	...
	<div class="row mt-5">
		...
		?>
			...
			<div class="col-4 border rounded">
			  	<div style="height: 300px; background-image: url(<?php echo $stroka["img"]; ?>); background-size: cover; background-position: center;">	  		
			  	</div>
				<form action="donate.php" method="GET">

					<input style="display: none" name="id" value="<?php echo $stroka["id"] ?>">

				  	<h3><?php echo $stroka["tittle"] ?></h3>
				  	<p class="mb-3"><?php echo $stroka["description"] ?></p>
				  	<p class="mb-2"><?php echo $stroka["user"] ?>, <?php echo $stroka["place"] ?></p>
